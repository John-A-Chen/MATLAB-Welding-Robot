...
L(1) = Revolute('d', 1.100, ...   % link length (Dennavit-Hartenberg notation)
    'a', 0.600, ...               % link offset (Dennavit-Hartenberg notation)
    ...
    'qlim', [-150, 150]*deg ); % minimum and maximum joint angle
