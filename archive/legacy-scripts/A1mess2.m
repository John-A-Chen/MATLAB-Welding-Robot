%% UR3e and Kuka Titan Movement Simulation with RMRC
startPositions = ...
[-1.8, 3, 1.3;
 -1.4, 3, 1.3;
 -1.0, 3, 1.3;
...
qdot2 = zeros(total_steps, 6);           % Array for Kuka Titan joint velocities
...
for i = 1:total_steps - 1
    ...
    linear_velocity2 = (1 / deltaT) * deltaX2;        % Linear velocity
...
% figure;
% subplot(2, 1, 1);
% plot(1:total_steps, qMatrix);
% title('UR3e Joint Angles');
% xlabel('Time Steps');
% ylabel('Joint Angles (rad)');
% grid on;
% 
% subplot(2, 1, 2);
% plot(1:total_steps, qMatrix2);
% title('Kuka Titan Joint Angles');
% xlabel('Time Steps');
% ylabel('Joint Angles (rad)');
% grid on;
% 
% % Visualize Robot Movements
% ur3e.model.plot(qMatrix', 'trail', 'r'); % UR3e path in red
% hold on;
% titan.model.plot(qMatrix2', 'trail', 'b'); % Kuka Titan path in blue
% title('Robot Movements');
% legend('UR3e', 'Kuka Titan');
%% Plot the movement
hold on;
for i = 1:total_steps
